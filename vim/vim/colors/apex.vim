" Name:       apex.vim
" Version:    0.1.0
" Maintainer: github.com/tomspeak
...
let g:colors_name='apex'

let s:black           = { "gui": "#000000", "cterm": "232" }
let s:light_black     = { "gui": "#444444", "cterm": "243" }
let s:dark_gray       = { "gui": "#495057", "cterm": "243" }
let s:medium_gray     = { "gui": "#212529", "cterm": "248" }
let s:light_gray      = { "gui": "#868E96", "cterm": "248" }
let s:lightest_gray   = { "gui": "#F1F3F5", "cterm": "248" }
let s:white           = { "gui": "#FFFFFF", "cterm": "231" }
let s:blue            = { "gui": "#00BAFF", "cterm": "12"  }
let s:red             = { "gui": "#F5ADAA", "cterm": "12"  }
let s:yellow          = { "gui": "#FDDDA1", "cterm": "12"  }
let s:green           = { "gui": "#75A088", "cterm": "12"  }
let s:visual          = { "gui": "#F1F3F5", "cterm": "141" }
...
call s:h("iCursor",        {"bg": s:blue, "fg": s:norm })
